...
do
    ...
    function Vector3.scaleScalar(v1, scalar)
        return Vector3:new(v1[1] * scalar, v1[2] * scalar, v1[3] * scalar)
    end
    ...
    function Vector3.squaredLength(v1)
        return v1[1] * v1[1] + v1[2] * v1[2] + v1[3] * v1[3]
    end
